...
var getLatestMessagePreview = function (channel, t, userLanguage, isMessageAIGenerated) {
    ...
    if (poll) {
        if (!poll.vote_count) {
            var createdBy = ((_b = poll.created_by) === null || _b === void 0 ? void 0 : _b.id) === channel.getClient().userID ? t('You') : (_d = (_c = poll.created_by) === null || _c === void 0 ? void 0 : _c.name) !== null && _d !== void 0 ? _d : t('Poll');
            return t('📊 {{createdBy}} created: {{ pollName}}', { createdBy: createdBy, pollName: poll.name });
        }
        else {
            ...
            if (option && latestVote_1) {
                return t('📊 {{votedBy}} voted: {{pollOptionText}}', {
                    ...
                    votedBy: ((_e = latestVote_1 === null || latestVote_1 === void 0 ? void 0 : latestVote_1.user) === null || _e === void 0 ? void 0 : _e.id) === channel.getClient().userID ? t('You') : (_g = (_f = latestVote_1.user) === null || _f === void 0 ? void 0 : _f.name) !== null && _g !== void 0 ? _g : t('Poll'),
                });
            }
        }
    }
    if (previewTextToRender) {
        return (isMessageAIGenerated === null || isMessageAIGenerated === void 0 ? void 0 : isMessageAIGenerated(latestMessage)) ? previewTextToRender : (0, exports.renderPreviewText)(previewTextToRender);
    }
