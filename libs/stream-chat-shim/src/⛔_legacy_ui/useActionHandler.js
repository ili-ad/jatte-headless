...
exports.handleActionWarning = void 0;
exports.useActionHandler = useActionHandler;
exports.handleActionWarning = 'Action handler was called, but it is missing one of its required arguments.' +
 ...
 */
function useActionHandler(_message) {
    var _this = this;
    return function (_dataOrName, _value, event) { return __awaiter(_this, void 0, void 0, function () {
        var _a;
...
exports.default = useActionHandler;
