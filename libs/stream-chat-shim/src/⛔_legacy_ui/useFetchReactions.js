...
function useFetchReactions(options) {
    var _this = this;
    var handleFetchReactions = options.handleFetchReactions, reactionType = options.reactionType, shouldFetch = options.shouldFetch, sort = options.sort;
    var _a = (0, react_1.useState)([]), reactions = _a[0], setReactions = _a[1];
    var _b = (0, react_1.useState)(shouldFetch), isLoading = _b[0], setIsLoading = _b[1];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        setIsLoading(true);
                        return [4 /*yield*/, (handleFetchReactions === null || handleFetchReactions === void 0 ? void 0 : handleFetchReactions(reactionType, sort))];
                    case 1:
                        fetched = _a.sent();
                        if (!cancel && fetched) {
...
exports.default = useFetchReactions;
