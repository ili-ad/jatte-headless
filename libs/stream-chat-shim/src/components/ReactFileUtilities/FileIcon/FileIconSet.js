...
exports.FileImageIcon = exports.FileFallbackIcon = exports.FileVideoIconAlt = exports.FileVideoIcon = exports.FileAudioIconAlt = exports.FileAudioIcon = exports.FileCodeIconAlt = exports.FileCodeIcon = exports.FileArchiveIconAlt = exports.FileArchiveIcon = exports.FileExcelIconAlt = exports.FileExcelIcon = exports.FilePowerPointIconAlt = exports.FilePowerPointIcon = exports.FileWordIconAlt = exports.FileWordIcon = exports.FilePdfIcon = void 0;
...
var FileWordIconAlt = function (_a) {
    var _b = _a.className, className = _b === void 0 ? '' : _b, _c = _a.size, size = _c === void 0 ? DEFAULT_SIZE : _c, props = __rest(_a, ["className", "size"]);
    return (<svg className={(0, clsx_1.default)('rfu-file-word-alt', className)} fill='none' height={size} viewBox='0 0 34 40' width={size} xmlns='http://www.w3.org/2000/svg' {...props}>
    <path d='M0 3C0 1.34315 1.34315 0 3 0H23L34 11V37C34 38.6569 32.6569 40 31 40H3C1.34315 40 0 38.6569 0 37V3Z' fill='url(#paint0_linear_11084_64)'/>
    ...
    <defs>
      <linearGradient gradientUnits='userSpaceOnUse' id='paint0_linear_11084_64' x1='0' x2='0' y1='0' y2='40'>
...
exports.FilePowerPointIconAlt = FilePowerPointIconAlt;
var FileExcelIcon = function (_a) {
    var _b = _a.className, className = _b === void 0 ? '' : _b, _c = _a.size, size = _c === void 0 ? DEFAULT_SIZE : _c, props = __rest(_a, ["className", "size"]);
    return (<svg className={(0, clsx_1.default)('rfu-file-excel', className)} fill='none' height={size} viewBox='0 0 34 40' width={size} xmlns='http://www.w3.org/2000/svg' {...props}>
    <path clipRule='evenodd' d='M17.7168 33.172C18.2348 33.172 18.4238 33.655 18.4238 34.18C18.4238 34.642 18.2978 35.195 17.7168 35.195C17.1708 35.195 16.9888 34.642 16.9888 34.145C16.9888 33.683 17.1708 33.172 17.7168 33.172ZM19.5718 31.002H18.3818V32.7589H18.3678C18.1228 32.43 17.7798 32.262 17.3318 32.262C16.3028 32.262 15.7988 33.158 15.7988 34.103C15.7988 35.125 16.2818 36.1049 17.4228 36.1049C17.8428 36.1049 18.1928 35.923 18.4238 35.58H18.4378V36H19.5718V31.002ZM12.7095 34.1872C12.7095 33.7252 12.8775 33.1722 13.4305 33.1722C13.9835 33.1722 14.1585 33.7252 14.1585 34.1872C14.1585 34.6492 13.9835 35.1952 13.4305 35.1952C12.8775 35.1952 12.7095 34.6492 12.7095 34.1872ZM11.5195 34.1872C11.5195 35.2792 12.3035 36.1052 13.4305 36.1052C14.5575 36.1052 15.3485 35.2792 15.3485 34.1872C15.3485 33.0952 14.5575 32.2622 13.4305 32.2622C12.3035 32.2622 11.5195 33.0952 11.5195 34.1872ZM21.839 32.3671H22.574V33.1371H21.839V34.7891C21.839 35.0761 22.007 35.1391 22.266 35.1391C22.3142 35.1391 22.364 35.1357 22.4147 35.1323C22.4672 35.1287 22.5206 35.1251 22.574 35.1251V36.0001C22.481 36.0031 22.388 36.0099 22.295 36.0168C22.171 36.0259 22.047 36.0351 21.923 36.0351C20.908 36.0351 20.649 35.7411 20.649 34.7541V33.1371H20.047V32.3671H20.649V31.2681H21.839V32.3671Z' fill='white' fillRule='evenodd'/>
    <path d='M0 28H34V37C34 38.6569 32.6569 40 31 40H3C1.34315 40 0 38.6569 0 37V28Z' fill='#0F9D58'/>
    <path d='M0 3C0 1.34315 1.34315 0 3 0H23L34 11V28H0V3Z' fill='#F5F5F5'/>
    <path d='M34 11L26 11C24.3431 11 23 9.65685 23 8V0L34 11Z' fill='#DBDBDB'/>
    <path clipRule='evenodd' d='M12 13H7V15H12V13ZM12 17H7V19H12V17ZM7 21H12V23H7V21ZM23 13H14V15H23V13ZM14 17H23V19H14V17ZM23 21H14V23H23V21Z' fill='#0F9D58' fillRule='evenodd'/>
  </svg>);
};
exports.FileExcelIcon = FileExcelIcon;
var FileExcelIconAlt = function (_a) {
    var _b = _a.className, className = _b === void 0 ? '' : _b, _c = _a.size, size = _c === void 0 ? DEFAULT_SIZE : _c, props = __rest(_a, ["className", "size"]);
    return (<svg className={(0, clsx_1.default)('rfu-file-excel-alt', className)} fill='none' height={size} viewBox='0 0 34 40' width={size} xmlns='http://www.w3.org/2000/svg' {...props}>
    <path d='M0 3C0 1.34315 1.34315 0 3 0H23L34 11V37C34 38.6569 32.6569 40 31 40H3C1.34315 40 0 38.6569 0 37V3Z' fill='url(#paint0_linear_11084_326)'/>
    <path d='M34 11L26 11C24.3431 11 23 9.65685 23 8V0L34 11Z' fill='#0C864B'/>
    <path clipRule='evenodd' d='M12 13H7V15H12V13ZM12 17H7V19H12V17ZM7 21H12V23H7V21ZM23 13H14V15H23V13ZM14 17H23V19H14V17ZM23 21H14V23H23V21Z' fill='#A8E7C9' fillRule='evenodd'/>
    <defs>
      <linearGradient gradientUnits='userSpaceOnUse' id='paint0_linear_11084_326' x1='0' x2='0' y1='0' y2='40'>
...
exports.FileExcelIconAlt = FileExcelIconAlt;
var FileArchiveIcon = function (_a) {
    var _b = _a.className, className = _b === void 0 ? '' : _b, _c = _a.size, size = _c === void 0 ? DEFAULT_SIZE : _c, props = __rest(_a, ["className", "size"]);
    return (<svg className={(0, clsx_1.default)('rfu-file-archive', className)} fill='none' height={size} viewBox='0 0 34 40' width={size} xmlns='http://www.w3.org/2000/svg' {...props}>
    <path clipRule='evenodd' d='M17.7168 33.172C18.2348 33.172 18.4238 33.655 18.4238 34.18C18.4238 34.642 18.2978 35.195 17.7168 35.195C17.1708 35.195 16.9888 34.642 16.9888 34.145C16.9888 33.683 17.1708 33.172 17.7168 33.172ZM19.5718 31.002H18.3818V32.7589H18.3678C18.1228 32.43 17.7798 32.262 17.3318 32.262C16.3028 32.262 15.7988 33.158 15.7988 34.103C15.7988 35.125 16.2818 36.1049 17.4228 36.1049C17.8428 36.1049 18.1928 35.923 18.4238 35.58H18.4378V36H19.5718V31.002ZM12.7095 34.1872C12.7095 33.7252 12.8775 33.1722 13.4305 33.1722C13.9835 33.1722 14.1585 33.7252 14.1585 34.1872C14.1585 34.6492 13.9835 35.1952 13.4305 35.1952C12.8775 35.1952 12.7095 34.6492 12.7095 34.1872ZM11.5195 34.1872C11.5195 35.2792 12.3035 36.1052 13.4305 36.1052C14.5575 36.1052 15.3485 35.2792 15.3485 34.1872C15.3485 33.0952 14.5575 32.2622 13.4305 32.2622C12.3035 32.2622 11.5195 33.0952 11.5195 34.1872ZM21.839 32.3671H22.574V33.1371H21.839V34.7891C21.839 35.0761 22.007 35.1391 22.266 35.1391C22.3142 35.1391 22.364 35.1357 22.4147 35.1323C22.4672 35.1287 22.5206 35.1251 22.574 35.1251V36.0001C22.481 36.0031 22.388 36.0099 22.295 36.0168C22.171 36.0259 22.047 36.0351 21.923 36.0351C20.908 36.0351 20.649 35.7411 20.649 34.7541V33.1371H20.047V32.3671H20.649V31.2681H21.839V32.3671Z' fill='white' fillRule='evenodd'/>
    <path d='M0 28H34V37C34 38.6569 32.6569 40 31 40H3C1.34315 40 0 38.6569 0 37V28Z' fill='#F8B859'/>
    <path d='M0 3C0 1.34315 1.34315 0 3 0H23L34 11V28H0V3Z' fill='#F5F5F5'/>
    <path d='M34 11L26 11C24.3431 11 23 9.65685 23 8V0L34 11Z' fill='#DBDBDB'/>
    <path clipRule='evenodd' d='M10 0H8V2H10V4H8V6H10V8H8V10H10V12H8V14H10V12H12V10H10V8H12V6H10V4H12V2H10V0ZM8 17C8 16.4477 8.44771 16 9 16H11C11.5523 16 12 16.4477 12 17V23C12 23.5523 11.5523 24 11 24H9C8.44771 24 8 23.5523 8 23V17ZM9 23V20H11V23H9Z' fill='#F8B859' fillRule='evenodd'/>
  </svg>);
};
exports.FileArchiveIcon = FileArchiveIcon;
var FileArchiveIconAlt = function (_a) {
    var _b = _a.className, className = _b === void 0 ? '' : _b, _c = _a.size, size = _c === void 0 ? DEFAULT_SIZE : _c, props = __rest(_a, ["className", "size"]);
    return (<svg className={(0, clsx_1.default)('rfu-file-archive-alt', className)} fill='none' height={size} viewBox='0 0 34 40' width={size} xmlns='http://www.w3.org/2000/svg' {...props}>
    <path d='M0 3C0 1.34315 1.34315 0 3 0H23L34 11V37C34 38.6569 32.6569 40 31 40H3C1.34315 40 0 38.6569 0 37V3Z' fill='url(#paint0_linear_11086_246)'/>
    <path d='M34 11L26 11C24.3431 11 23 9.65685 23 8V0L34 11Z' fill='#B67A24'/>
    <path clipRule='evenodd' d='M10 0H8V2H10V4H8V6H10V8H8V10H10V12H8V14H10V12H12V10H10V8H12V6H10V4H12V2H10V0ZM8 17C8 16.4477 8.44771 16 9 16H11C11.5523 16 12 16.4477 12 17V23C12 23.5523 11.5523 24 11 24H9C8.44771 24 8 23.5523 8 23V17ZM9 23V20H11V23H9Z' fill='#FFE9C8' fillRule='evenodd'/>
    <defs>
      <linearGradient gradientUnits='userSpaceOnUse' id='paint0_linear_11086_246' x1='0' x2='0' y1='0' y2='40'>
...
exports.FileArchiveIconAlt = FileArchiveIconAlt;
var FileCodeIcon = function (_a) {
    var _b = _a.className, className = _b === void 0 ? '' : _b, _c = _a.size, size = _c === void 0 ? DEFAULT_SIZE : _c, props = __rest(_a, ["className", "size"]);
    return (<svg className={(0, clsx_1.default)('rfu-file-code', className)} fill='none' height={size} viewBox='0 0 34 40' width={size} xmlns='http://www.w3.org/2000/svg' {...props}>
    <path d='M0 28H34V37C34 38.6569 32.6569 40 31 40H3C1.34315 40 0 38.6569 0 37V28Z' fill='#00ACA1'/>
    <path d='M0 3C0 1.34315 1.34315 0 3 0H23L34 11V28H0V3Z' fill='#F5F5F5'/>
    <path d='M34 11L26 11C24.3431 11 23 9.65685 23 8V0L34 11Z' fill='#DBDBDB'/>
    <path clipRule='evenodd' d='M15 21V18.984L11.5 18L15 17V15L9 17V19L15 21ZM19 15V17.016L22.5 18L19 19V21L25 19V17L19 15Z' fill='#00ACA1' fillRule='evenodd'/>
  </svg>);
};
exports.FileCodeIcon = FileCodeIcon;
var FileCodeIconAlt = function (_a) {
    var _b = _a.className, className = _b === void 0 ? '' : _b, _c = _a.size, size = _c === void 0 ? DEFAULT_SIZE : _c, props = __rest(_a, ["className", "size"]);
    return (<svg className={(0, clsx_1.default)('rfu-file-code-alt', className)} fill='none' height={size} viewBox='0 0 34 40' width={size} xmlns='http://www.w3.org/2000/svg' {...props}>
    <path d='M0 3C0 1.34315 1.34315 0 3 0H23L34 11V37C34 38.6569 32.6569 40 31 40H3C1.34315 40 0 38.6569 0 37V3Z' fill='url(#paint0_linear_11086_611)'/>
    <path d='M34 11L26 11C24.3431 11 23 9.65685 23 8V0L34 11Z' fill='#00ACA1'/>
    <path clipRule='evenodd' d='M15 21V18.984L11.5 18L15 17V15L9 17V19L15 21ZM19 15V17.016L22.5 18L19 19V21L25 19V17L19 15Z' fill='#A3DCD8' fillRule='evenodd'/>
    <defs>
      <linearGradient gradientUnits='userSpaceOnUse' id='paint0_linear_11086_611' x1='0' x2='0' y1='0' y2='40'>
...
var FileAudioIconAlt = function (_a) {
    ...
    <defs>
      <linearGradient gradientUnits='userSpaceOnUse' id='paint0_linear_11086_420' x1='0' x2='0' y1='0' y2='40'>
...
exports.FileAudioIconAlt = FileAudioIconAlt;
var FileVideoIcon = function (_a) {
    var _b = _a.className, className = _b === void 0 ? '' : _b, _c = _a.size, size = _c === void 0 ? DEFAULT_SIZE : _c, props = __rest(_a, ["className", "size"]);
    return (<svg className={(0, clsx_1.default)('rfu-file-video', className)} fill='none' height={size} viewBox='0 0 34 40' width={size} xmlns='http://www.w3.org/2000/svg' {...props}>
    <path clipRule='evenodd' d='M17.7168 33.172C18.2348 33.172 18.4238 33.655 18.4238 34.18C18.4238 34.642 18.2978 35.195 17.7168 35.195C17.1708 35.195 16.9888 34.642 16.9888 34.145C16.9888 33.683 17.1708 33.172 17.7168 33.172ZM19.5718 31.002H18.3818V32.7589H18.3678C18.1228 32.43 17.7798 32.262 17.3318 32.262C16.3028 32.262 15.7988 33.158 15.7988 34.103C15.7988 35.125 16.2818 36.1049 17.4228 36.1049C17.8428 36.1049 18.1928 35.923 18.4238 35.58H18.4378V36H19.5718V31.002ZM12.7095 34.1872C12.7095 33.7252 12.8775 33.1722 13.4305 33.1722C13.9835 33.1722 14.1585 33.7252 14.1585 34.1872C14.1585 34.6492 13.9835 35.1952 13.4305 35.1952C12.8775 35.1952 12.7095 34.6492 12.7095 34.1872ZM11.5195 34.1872C11.5195 35.2792 12.3035 36.1052 13.4305 36.1052C14.5575 36.1052 15.3485 35.2792 15.3485 34.1872C15.3485 33.0952 14.5575 32.2622 13.4305 32.2622C12.3035 32.2622 11.5195 33.0952 11.5195 34.1872ZM21.839 32.3671H22.574V33.1371H21.839V34.7891C21.839 35.0761 22.007 35.1391 22.266 35.1391C22.3142 35.1391 22.364 35.1357 22.4147 35.1323C22.4672 35.1287 22.5206 35.1251 22.574 35.1251V36.0001C22.481 36.0031 22.388 36.0099 22.295 36.0168C22.171 36.0259 22.047 36.0351 21.923 36.0351C20.908 36.0351 20.649 35.7411 20.649 34.7541V33.1371H20.047V32.3671H20.649V31.2681H21.839V32.3671Z' fill='white' fillRule='evenodd'/>
    <path d='M0 28H34V37C34 38.6569 32.6569 40 31 40H3C1.34315 40 0 38.6569 0 37V28Z' fill='#9D27B0'/>
    <path d='M0 3C0 1.34315 1.34315 0 3 0H23L34 11V28H0V3Z' fill='#F5F5F5'/>
    <path d='M34 11L26 11C24.3431 11 23 9.65685 23 8V0L34 11Z' fill='#DBDBDB'/>
    <path d='M9 17H25V24H9V17ZM27 14C27 12.8954 26.1046 12 25 12H22L24 15H21L19 12H17L19 15H16L14 12H12L14 15H11L9 12C7.9 12 7.01 12.9 7.01 14L7 24C7 25.1 7.9 26 9 26H25C26.1 26 27 25.1 27 24V14Z' fill='#9D27B0'/>
  </svg>);
};
exports.FileVideoIcon = FileVideoIcon;
var FileVideoIconAlt = function (_a) {
    var _b = _a.className, className = _b === void 0 ? '' : _b, _c = _a.size, size = _c === void 0 ? DEFAULT_SIZE : _c, props = __rest(_a, ["className", "size"]);
    return (<svg className={(0, clsx_1.default)('rfu-file-video-alt', className)} fill='none' height={size} viewBox='0 0 34 40' width={size} xmlns='http://www.w3.org/2000/svg' {...props}>
    <path d='M0 3C0 1.34315 1.34315 0 3 0H23L34 11V37C34 38.6569 32.6569 40 31 40H3C1.34315 40 0 38.6569 0 37V3Z' fill='url(#paint0_linear_18604_164254)'/>
    <path d='M34 11L26 11C24.3431 11 23 9.65685 23 8V0L34 11Z' fill='#7A1589'/>
    <path d='M9 17H25V24H9V17ZM27 14C27 12.8954 26.1046 12 25 12H22L24 15H21L19 12H17L19 15H16L14 12H12L14 15H11L9 12C7.9 12 7.01 12.9 7.01 14L7 24C7 25.1 7.9 26 9 26H25C26.1 26 27 25.1 27 24V14Z' fill='#F3A8FF'/>
    <defs>
      <linearGradient gradientUnits='userSpaceOnUse' id='paint0_linear_18604_164254' x1='0' x2='0' y1='0' y2='40'>
...
exports.FileVideoIconAlt = FileVideoIconAlt;
var FileFallbackIcon = function (_a) {
    var _b = _a.className, className = _b === void 0 ? '' : _b, _c = _a.size, size = _c === void 0 ? DEFAULT_SIZE : _c, props = __rest(_a, ["className", "size"]);
    return (<svg className={(0, clsx_1.default)('rfu-file-fallback ', className)} fill='none' height={size} viewBox='0 0 34 40' width={size} xmlns='http://www.w3.org/2000/svg' {...props}>
    <path d='M0 3C0 1.34315 1.34315 0 3 0H23L34 11V37C34 38.6569 32.6569 40 31 40H3C1.34315 40 0 38.6569 0 37V3Z' fill='url(#paint0_linear)'/>
    <path d='M34 11L26 11C24.3431 11 23 9.65685 23 8V0L34 11Z' fill='#DBDBDB'/>
    ...
    <defs>
      <linearGradient gradientUnits='userSpaceOnUse' id='paint0_linear' x1='0' x2='0' y1='0' y2='40'>
...
exports.FileFallbackIcon = FileFallbackIcon;
// v1 icon without possibility to specify size via props
var FileImageIcon = function (_a) {
    var _b = _a.className, className = _b === void 0 ? '' : _b, _c = _a.size, size = _c === void 0 ? DEFAULT_SIZE : _c, props = __rest(_a, ["className", "size"]);
    return (<svg className={(0, clsx_1.default)('rfu-file-image', className)} height={size} viewBox='0 0 384 512' width={size} xmlns='http://www.w3.org/2000/svg' {...props}>
