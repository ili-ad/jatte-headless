...
exports.generateFileName = exports.readFileAsArrayBuffer = exports.getRecordedMediaTypeFromMimeType = exports.getExtensionFromMimeType = exports.createFileFromBlobs = exports.isBlobButNotFile = exports.useHandleFileChangeWrapper = void 0;
...
var isBlobButNotFile = function (obj) {
    return obj instanceof Blob && !(obj instanceof File);
};
exports.isBlobButNotFile = isBlobButNotFile;
...
var generateFileName = function (mimeType) {
    return "file_".concat(new Date().toISOString(), ".").concat((0, exports.getExtensionFromMimeType)(mimeType));
};
