...
function usePrependedMessagesCount(messages, hasDateSeparator) {
    ...
    var firstMessageOnFirstLoadedPage = (0, react_1.useRef)(undefined);
    var previousFirstMessageOnFirstLoadedPage = (0, react_1.useRef)(undefined);
    var previousNumItemsPrepended = (0, react_1.useRef)(0);
    var numItemsPrepended = (0, react_1.useMemo)(function () {
        var _a, _b;
        ...
        var currentFirstMessageStatus = (0, utils_1.isLocalMessage)(currentFirstMessage)
            ? currentFirstMessage.status
            : undefined;
        var firstMsgMovedAfterMessagesInExcludedStatus = !!(currentFirstMessageStatus &&
