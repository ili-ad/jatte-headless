...
// import type { LocalMessage, MessageLabel, UserResponse } from 'stream-chat'; // TODO backend-wire-up
type LocalMessage = any;
type MessageLabel = any;
...
export type ProcessMessagesParams = ProcessMessagesContext & {
  ...
  setGiphyPreviewMessage?: React.Dispatch<
    React.SetStateAction<LocalMessage | undefined>
  >;
};
...
export const getGroupStyles = (
  ...
  const isTopMessage =
    ...
    (message.reaction_groups &&
      Object.keys(message.reaction_groups).length > 0) ||
