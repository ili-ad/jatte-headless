...
const VirtualizedMessageListWithContext = (
  ...
  const MessageUIComponent =
    MessageUIComponentFromProps || MessageUIComponentFromContext;
  ...
  const messageGroupStyles = useMemo(
    () =>
      processedMessages.reduce<Record<string, GroupStyle>>(
        (acc, message, i) => {
  ...
  return (
    <VirtualizedMessageListContextProvider value={{ scrollToBottom }}>
      ...
      <MessageListNotifications
        ...
        unreadCount={
          threadList ? undefined : channelUnreadUiState?.unread_messages
        }
      />
      {giphyPreviewMessage && (
        <GiphyPreviewMessage message={giphyPreviewMessage} />
      )}
