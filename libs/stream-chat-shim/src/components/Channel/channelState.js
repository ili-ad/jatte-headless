...
var makeChannelReducer = function () { return function (state, action) {
    var _a;
    switch (action.type) {
        case 'closeThread': {
        ...
        case 'jumpToMessageFinished': {
            return __assign(__assign({}, state), { hasMoreNewer: action.channel.state.messagePagination.hasNext, highlightedMessageId: action.highlightedMessageId, messages: action.channel.state.messages });
        }
        ...
        case 'openThread': {
            ...
            return __assign(__assign({}, state), { thread: message, threadHasMore: true, threadMessages: message.id
        ...
        case 'updateThreadOnEvent': {
            ...
            return __assign(__assign({}, state), { thread: (message === null || message === void 0 ? void 0 : message.id) === state.thread.id
                    ...
                    : state.thread, threadMessages: ((_a = state.thread) === null || _a === void 0 ? void 0 : _a.id)
                    ? __assign({}, channel.state.threads)[state.thread.id] || []
                    : [] });
        }
        default:
            return state;
