...
exports.Icon = {
    ArchiveBox: function (props) { return (<svg className="str-chat__icon str-chat__icon--archive-box" fill="currentColor" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    Pin: function (props) { return (<svg className="str-chat__icon str-chat__icon--pin" fill="currentColor" viewBox="0 0 384 512" xmlns="http://www.w3.org/2000/svg" {...props}>
