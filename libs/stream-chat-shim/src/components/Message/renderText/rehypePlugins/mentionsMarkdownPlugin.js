...
exports.mentionsMarkdownPlugin = void 0;
...
var mentionsMarkdownPlugin = function (mentioned_users) { return function () {
    ...
    var replace = function (match) {
        ...
        return (0, unist_builder_1.u)('element', { mentionedUser: user, properties: {}, tagName: 'mention' }, [
            (0, unist_builder_1.u)('text', match),
        ]);
    };
    var transform = function (tree) {
        ...
        (0, unist_util_visit_1.visit)(tree, function (node, index, parent) {
            ...
            if (node.type === 'text' &&
                ...
                parent.children[index] = (0, unist_builder_1.u)('text', newTextValue);
                parent.children[index + 1] = (0, unist_builder_1.u)('text', "@".concat(username));
            }
        });
        (0, hast_util_find_and_replace_1.findAndReplace)(tree, [mentionedUsersRegex, replace]);
    };
    return transform;
}; };
