...
exports.MessageErrorIcon = exports.MessageDeliveredIcon = exports.PinIndicator = exports.PinIcon = exports.ThreadIcon = exports.ReactionIcon = exports.ActionsIcon = void 0;
var react_1 = require("react");
var ActionsIcon = function (_a) {
    var _b = _a.className, className = _b === void 0 ? '' : _b;
    return (<svg className={className} height='4' viewBox='0 0 11 4' width='11' xmlns='http://www.w3.org/2000/svg'>
...
var ReactionIcon = function (_a) {
    var _b = _a.className, className = _b === void 0 ? '' : _b;
    return (<svg className={className} height='12' viewBox='0 0 12 12' width='12' xmlns='http://www.w3.org/2000/svg'>
...
var ThreadIcon = function (_a) {
    var _b = _a.className, className = _b === void 0 ? '' : _b;
    return (<svg className={className} height='10' width='14' xmlns='http://www.w3.org/2000/svg'>
    <path d='M8.516 3c4.78 0 4.972 6.5 4.972 6.5-1.6-2.906-2.847-3.184-4.972-3.184v2.872L3.772 4.994 8.516.5V3zM.484 5l4.5-4.237v1.78L2.416 5l2.568 2.125v1.828L.484 5z' fillRule='evenodd'/>
  </svg>);
};
exports.ThreadIcon = ThreadIcon;
var PinIcon = function () { return (<svg height='13' viewBox='0 0 14 13' width='14' xmlns='http://www.w3.org/2000/svg'>
...
var MessageDeliveredIcon = function () { return (<svg data-testid='delivered-icon' fill='none' height='24' viewBox='0 0 24 24' width='24' xmlns='http://www.w3.org/2000/svg'>
    <path clipRule='evenodd' d='M8.9999 16.2L4.7999 12L3.3999 13.4L8.9999 19L20.9999 6.99998L19.5999 5.59998L8.9999 16.2Z' fill='black' fillRule='evenodd'/>
  </svg>); };
exports.MessageDeliveredIcon = MessageDeliveredIcon;
var MessageErrorIcon = function () { return (<div className='str-chat__message-error-icon'>
    <svg data-testid='error' fill='none' height='24' viewBox='0 0 24 24' width='24' xmlns='http://www.w3.org/2000/svg'>
      <path d='M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2Z' fill='black' id='background'/>
