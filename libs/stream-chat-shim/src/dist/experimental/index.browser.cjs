...
var require_inline_style_parser = __commonJS({
  "../../node_modules/.pnpm/inline-style-parser@0.2.4/node_modules/inline-style-parser/index.js"(exports, module2) {
    var COMMENT_REGEX = /\/\*[^*]*\*+([^/*][^*]*\*+)*\//g;
    var NEWLINE_REGEX = /\n/g;
...
var require_cjs2 = __commonJS({
  "../../node_modules/.pnpm/style-to-js@1.1.16/node_modules/style-to-js/cjs/index.js"(exports, module2) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
// ../../node_modules/.pnpm/react-markdown@9.1.0_@types+react@19.1.8_react@18.2.0/node_modules/react-markdown/lib/index.js
...
// src/components/ChannelPreview/utils.tsx
var renderPreviewText = (text5) => /* @__PURE__ */ import_react21.default.createElement(Markdown, { skipHtml: true }, text5);
...
var useChannelPreviewInfo = (props) => {
  ...
  const [displayTitle, setDisplayTitle] = (0, import_react22.useState)(
    () => overrideTitle || getDisplayTitle(channel, client.user)
  );
  const [displayImage, setDisplayImage] = (0, import_react22.useState)(
    () => overrideImage || getDisplayImage(channel, client.user)
  );
  const [groupChannelDisplayInfo, setGroupDisplayChannelInfo] = (0, import_react22.useState)(() => getGroupChannelDisplayInfo(channel));
...
var useMessageDeliveryStatus = ({
  ...
  const [messageDeliveryStatus, setMessageDeliveryStatus] = (0, import_react23.useState)();
  const isOwnMessage = (0, import_react23.useCallback)(
...
var ChannelPreview = (props) => {
  ...
  const [lastMessage, setLastMessage] = (0, import_react24.useState)(
    channel.state.messages[channel.state.messages.length - 1]
  );
  const [unread, setUnread] = (0, import_react24.useState)(0);
  ...
  const refreshUnreadCount = (0, import_react24.useMemo)(
...
var LegacyThreadContext = import_react25.default.createContext({ legacyThread: void 0 });
var useLegacyThreadContext = () => (0, import_react25.useContext)(LegacyThreadContext);
...
var useMessageReminder = (messageId) => {
  const { client } = useChatContext();
  const reminderSelector = (0, import_react26.useCallback)(
    (state) => ({
...
function useDialogAnchor({
  ...
  const [popperElement, setPopperElement] = (0, import_react27.useState)(null);
...
var DialogAnchor = ({
  ...
  return /* @__PURE__ */ import_react27.default.createElement(DialogPortalEntry, { dialogId: id }, /* @__PURE__ */ import_react27.default.createElement(import_focus.FocusScope, { autoFocus: focus, contain: trapFocus, restoreFocus: true }, /* @__PURE__ */ import_react27.default.createElement(
    "div",
    {
      ...restDivProps,
      ...attributes.popper,
...
var ButtonWithSubmenu = ({
  ...
  const [dialogContainer, setDialogContainer] = (0, import_react28.useState)(null);
  const keepSubmenuOpen = (0, import_react28.useRef)(false);
  const dialogCloseTimeout = (0, import_react28.useRef)(null);
  const dialogId = (0, import_react28.useMemo)(() => `submenu-${Math.random().toString(36).slice(2)}`, []);
  ...
  const closeDialogLazily = (0, import_react28.useCallback)(() => {
  ...
  return /* @__PURE__ */ import_react28.default.createElement(import_react28.default.Fragment, null, /* @__PURE__ */ import_react28.default.createElement(
    ...
    children
  ), dialogIsOpen && /* @__PURE__ */ import_react28.default.createElement(
    "div",
    {
      ...attributes.popper,
      onBlur: (event) => {
    ...
    /* @__PURE__ */ import_react28.default.createElement(Submenu, null)
  ));
};
...
var RemindMeSubmenu = () => {
  ...
  return /* @__PURE__ */ import_react29.default.createElement(
    ...
    client.reminders.scheduledOffsetsMs.map((offsetMs) => /* @__PURE__ */ import_react29.default.createElement(
      "button",
      {
...
var ActionsIcon = ({ className = "" }) => /* @__PURE__ */ import_react30.default.createElement(
  "svg",
  {
    className,
    height: "4",
...
var ReactionIcon = ({ className = "" }) => /* @__PURE__ */ import_react30.default.createElement(
  "svg",
  {
    className,
    height: "12",
  ...
  /* @__PURE__ */ import_react30.default.createElement("g", { clipRule: "evenodd", fillRule: "evenodd" }, /* @__PURE__ */ import_react30.default.createElement("path", { d: "M6 1.2C3.3 1.2 1.2 3.3 1.2 6c0 2.7 2.1 4.8 4.8 4.8 2.7 0 4.8-2.1 4.8-4.8 0-2.7-2.1-4.8-4.8-4.8zM0 6c0-3.3 2.7-6 6-6s6 2.7 6 6-2.7 6-6 6-6-2.7-6-6z" }), /* @__PURE__ */ import_react30.default.createElement("path", { d: "M5.4 4.5c0 .5-.4.9-.9.9s-.9-.4-.9-.9.4-.9.9-.9.9.4.9.9zM8.4 4.5c0 .5-.4.9-.9.9s-.9-.4-.9-.9.4-.9.9-.9.9.4.9.9zM3.3 6.7c.3-.2.6-.1.8.1.3.4.8.9 1.5 1 .6.2 1.4.1 2.4-1 .2-.2.6-.3.8 0 .2.2.3.6 0 .8-1.1 1.3-2.4 1.7-3.5 1.5-1-.2-1.8-.9-2.2-1.5-.2-.3-.1-.7.2-.9z" }))
);
var ThreadIcon = ({ className = "" }) => /* @__PURE__ */ import_react30.default.createElement("svg", { className, height: "10", width: "14", xmlns: "http://www.w3.org/2000/svg" }, /* @__PURE__ */ import_react30.default.createElement(
  "path",
  {
...
var MessageActionsWrapper = (props) => {
  ...
  if (inline) return /* @__PURE__ */ import_react31.default.createElement("span", { ...wrapperProps }, children);
  return /* @__PURE__ */ import_react31.default.createElement("div", { ...wrapperProps }, children);
};
...
var SpriteImage = ({
  ...
  const [[spriteWidth, spriteHeight], setSpriteDimensions] = (0, import_react32.useState)([0, 0]);
  (0, import_react32.useEffect)(() => {
    getImageDimensions(spriteUrl).then(setSpriteDimensions).catch(console.error);
  }, [spriteUrl]);
  const [x, y] = position3;
  if (!spriteHeight || !spriteWidth) return /* @__PURE__ */ import_react32.default.createElement(import_react32.default.Fragment, null, fallback);
...
var defaultReactionOptions = [
  {
    type: "haha",
    Component: () => /* @__PURE__ */ import_react34.default.createElement(StreamEmoji, { fallback: "\u{1F602}", type: "haha" }),
    name: "Joy"
  },
  {
    type: "like",
    Component: () => /* @__PURE__ */ import_react34.default.createElement(StreamEmoji, { fallback: "\u{1F44D}", type: "like" }),
    name: "Thumbs up"
  },
  {
    type: "love",
    Component: () => /* @__PURE__ */ import_react34.default.createElement(StreamEmoji, { fallback: "\u2764\uFE0F", type: "love" }),
    name: "Heart"
  },
  { type: "sad", Component: () => /* @__PURE__ */ import_react34.default.createElement(StreamEmoji, { fallback: "\u{1F614}", type: "sad" }), name: "Sad" },
  {
    type: "wow",
    Component: () => /* @__PURE__ */ import_react34.default.createElement(StreamEmoji, { fallback: "\u{1F632}", type: "wow" }),
    name: "Astonished"
  }
];
...
var UnMemoizedReactionSelector = (props) => {
  ...
  const [tooltipReactionType, setTooltipReactionType] = (0, import_react35.useState)(null);
  const [tooltipPositions, setTooltipPositions] = (0, import_react35.useState)(null);
  const rootRef = (0, import_react35.useRef)(null);
  const targetRef = (0, import_react35.useRef)(null);
  const tooltipRef = (0, import_react35.useRef)(null);
  const showTooltip = (0, import_react35.useCallback)(
    (event, reactionType) => {
  ...
  const hideTooltip = (0, import_react35.useCallback)(() => {
  ...
  return /* @__PURE__ */ import_react35.default.createElement(
    ...
    !!tooltipReactionType && detailedView && /* @__PURE__ */ import_react35.default.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ import_react35.default.createElement("div", { className: "arrow", style: { left: tooltipPositions?.arrow } }),
      getUsersPerReactionType(tooltipReactionType)?.map((user, i, users) => /* @__PURE__ */ import_react35.default.createElement("span", { className: "latest-user-username", key: `key-${i}-${user}` }, `${user}${i < users.length - 1 ? ", " : ""}`))
    ),
    /* @__PURE__ */ import_react35.default.createElement("ul", { className: "str-chat__message-reactions-list str-chat__message-reactions-options" }, reactionOptions.map(({ Component, name: reactionName, type: reactionType }) => {
      const latestUser = getLatestUserForReactionType(reactionType);
      const count = reactionGroups[reactionType]?.count ?? 0;
      return /* @__PURE__ */ import_react35.default.createElement("li", { key: reactionType }, /* @__PURE__ */ import_react35.default.createElement(
        "button",
        {
        ...
        !!count && detailedView && /* @__PURE__ */ import_react35.default.createElement(
          "div",
          {
          ...
          latestUser ? /* @__PURE__ */ import_react35.default.createElement(
            Avatar2,
            {
          ...
          ) : /* @__PURE__ */ import_react35.default.createElement("div", { className: "latest-user-not-found" })
        ),
        /* @__PURE__ */ import_react35.default.createElement("span", { className: "str-chat__message-reaction-emoji" }, /* @__PURE__ */ import_react35.default.createElement(Component, null)),
        Boolean(count) && detailedView && /* @__PURE__ */ import_react35.default.createElement("span", { className: "str-chat__message-reactions-list-item__count" }, count || "")
      ));
    }))
  );
};
var ReactionSelector = import_react35.default.memo(
...
var ReactionSelectorWithButton = ({
  ...
  return /* @__PURE__ */ import_react36.default.createElement(import_react36.default.Fragment, null, /* @__PURE__ */ import_react36.default.createElement(
    ...
    /* @__PURE__ */ import_react36.default.createElement(ReactionSelector2, null)
    ...
    /* @__PURE__ */ import_react36.default.createElement(ReactionIcon2, { className: "str-chat__message-action-icon" })
  ));
};
...
var InfiniteScrollPaginator = (props) => {
  ...
  const childRef = (0, import_react37.useRef)(null);
  const scrollListener = (0, import_react37.useMemo)(
  ...
  return /* @__PURE__ */ import_react37.default.createElement(
    ...
    /* @__PURE__ */ import_react37.default.createElement("div", { className: "str-chat__infinite-scroll-paginator__content", ref: childRef }, children)
  );
};
...
var DefaultMessageActionComponents = {
  dropdown: {
    ...
    Delete() {
      ...
      const { t } = useTranslationContext();
      return /* @__PURE__ */ import_react42.default.createElement(DefaultDropdownActionButton, { onClick: handleDelete }, t("Delete"));
    },
    RemindMe() {
