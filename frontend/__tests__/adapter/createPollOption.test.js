...
(0, vitest_1.test)('createPollOption posts option to API', function () { return __awaiter(void 0, void 0, void 0, function () {
    var client, res;
            ...
            case 0:
                global.fetch.mockResolvedValue({
                    ...
                    json: function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                        return [2 /*return*/, ({ poll_option: { id: 'opt1' } })];
                    }); }); },
                });
                client = new ChatClient_1.ChatClient('u1', 'jwt-test');
                return [4 /*yield*/, client.createPollOption('p1', { text: 'hi' })];
            case 1:
                res = _a.sent();
                (0, vitest_1.expect)(global.fetch).toHaveBeenCalledWith("".concat(constants_1.API.POLLS, "p1/options/"), {
                    method: 'POST',
                    headers: {
