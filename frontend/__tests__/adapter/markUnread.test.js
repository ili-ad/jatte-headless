...
(0, vitest_1.test)('markUnread posts to backend and clears read state', function () { return __awaiter(void 0, void 0, void 0, function () {
    var client, channel;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                (0, vitest_1.expect)(global.fetch).toHaveBeenCalledWith('/api/rooms/room1/mark_unread/', {
                    method: 'POST',
                    headers: { Authorization: 'Bearer jwt-test' },
                });
                (0, vitest_1.expect)(channel.state.read['u1']).toBeUndefined();
                return [2 /*return*/];
        }
    });
}); });
