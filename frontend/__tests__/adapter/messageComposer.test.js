...
(0, vitest_1.test)('submit sends message and clears text', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                channel.on(constants_1.EVENTS.MESSAGE_NEW, eventSpy);
                channel.messageComposer.textComposer.setText('hello');
                return [4 /*yield*/, channel.messageComposer.submit()];
            case 1:
                _a.sent();
