...
(0, vitest_1.test)('compose returns local message payload', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, channel.messageComposer.compose()];
            case 1:
                result = _a.sent();
            ...
            case 2:
                ...
                (0, vitest_1.expect)(result.message.text).toBe('hello');
                (0, vitest_1.expect)(result.localMessage.id).toMatch(/^local-/);
                return [2 /*return*/];
        }
    });
}); });
