...
(0, vitest_1.test)('getDraft fetches saved draft and updates text', function () { return __awaiter(void 0, void 0, void 0, function () {
    var client, channel, text;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, channel.messageComposer.getDraft()];
            case 1:
                text = _a.sent();
                (0, vitest_1.expect)(global.fetch).toHaveBeenCalledWith('/api/rooms/room1/draft/', {
                    headers: {
