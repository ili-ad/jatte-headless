    ...
    global.fetch = vitest_1.vi.fn(function () {
        return Promise.resolve({
            ...
            json: function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                return [2 /*return*/, ({ id: 'm1', text: 'edited', user_id: 'u1', created_at: '2025-01-01T00:00:00Z', updated_at: '2025-01-01T00:01:00Z' })];
            }); }); },
        });
    });
});
...
(0, vitest_1.test)('updateMessage PUTs to backend and updates state', function () { return __awaiter(void 0, void 0, void 0, function () {
    var client, channel, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                channel.state.latestMessages = __spreadArray([], channel.state.messages, true);
                return [4 /*yield*/, channel.updateMessage('m1', 'edited')];
            case 1:
                result = _a.sent();
                (0, vitest_1.expect)(global.fetch).toHaveBeenCalledWith("".concat(constants_1.API.MESSAGES, "m1/"), {
                    method: 'PUT',
                    headers: {
                ...
                (0, vitest_1.expect)(result.text).toBe('edited');
                (0, vitest_1.expect)(result.updated_at).toBe('2025-01-01T00:01:00Z');
                return [2 /*return*/];
        }
    });
}); });
