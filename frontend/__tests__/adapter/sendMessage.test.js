...
(0, vitest_1.test)('sendMessage posts message, updates state, and emits event', function () { return __awaiter(void 0, void 0, void 0, function () {
    var client, channel, eventSpy;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                eventSpy = vitest_1.vi.fn();
                client.on(constants_1.EVENTS.MESSAGE_NEW, eventSpy);
