...
(0, vitest_1.test)('sendAction posts action to API', function () { return __awaiter(void 0, void 0, void 0, function () {
    var client, channel;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, channel.sendAction('m1', { vote: 'yes' })];
            case 1:
                _a.sent();
                (0, vitest_1.expect)(global.fetch).toHaveBeenCalledWith("".concat(constants_1.API.MESSAGES, "m1/actions/"), {
                    method: 'POST',
                    headers: {
