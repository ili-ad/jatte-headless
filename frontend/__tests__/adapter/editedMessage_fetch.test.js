...
(0, vitest_1.test)('editedMessage fetches message and updates state', function () { return __awaiter(void 0, void 0, void 0, function () {
    var client, channel, msg;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, channel.editedMessage('m1')];
            case 1:
                msg = _a.sent();
