...
(0, vitest_1.test)('customDataManager set and clear modify state', function () {
    var client = new ChatClient_1.ChatClient('u1', 'jwt-test');
    var channel = client.channel('messaging', 'room1');
    var mgr = channel.messageComposer.customDataManager;
    mgr.set('foo', 1);
    (0, vitest_1.expect)(mgr.state.getSnapshot().customData.foo).toBe(1);
    mgr.clear();
    (0, vitest_1.expect)(mgr.state.getSnapshot().customData).toEqual({});
});
(0, vitest_1.test)('sendMessage includes custom_data payload', function () { return __awaiter(void 0, void 0, void 0, function () {
    var client, channel;
            ...
            case 0:
                global.fetch.mockResolvedValue({
                    ...
                    json: function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                        return [2 /*return*/, ({ id: 'm1', text: 'hello', user_id: 'u1', created_at: '2025-01-01T00:00:00Z', custom_data: { foo: 1 } })];
                    }); }); },
                });
                ...
                return [4 /*yield*/, channel.sendMessage({ text: 'hello' })];
            case 1:
                _a.sent();
