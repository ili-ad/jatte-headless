...
from stream_server_django.events.models import EventNotification, EventSubscription  # noqa: E402
...
class EventsApiTests(APITestCase):
    ...
    def test_register_subscriptions_persists_payload(self) -> None:
        ...
        payload = {"subscriptions": {"stream_server_django.polls": {"enabled": True}}}
    ...
    def test_listeners_returns_expected_channels(self) -> None:
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.json(), {"listeners": ["stream_server_django.polls", "threads", "stream_server_django.reminders"]})
