...
class MessageAttachmentSerializer(serializers.Serializer):
    ...
    storage_bucket = serializers.CharField(required=False)
    storage_class = serializers.CharField(required=False)
    object_generation = serializers.CharField(required=False, allow_null=True)
    ...
    scan_engine = serializers.CharField(read_only=True, required=False)
    scan_engine_version = serializers.CharField(read_only=True, required=False)
    scan_definition_version = serializers.CharField(read_only=True, required=False)
    scan_verified_sha256 = serializers.CharField(read_only=True, required=False)
    scan_verified_size = serializers.IntegerField(read_only=True, required=False)
    scan_provider_at = serializers.CharField(read_only=True, required=False)
