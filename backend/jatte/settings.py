...
CHAT_ATTACHMENTS_PENDING_BUCKET = os.environ.get(
    "CHAT_ATTACHMENTS_PENDING_BUCKET", CHAT_ATTACHMENTS_BUCKET
)
CHAT_ATTACHMENTS_CLEAN_BUCKET = os.environ.get("CHAT_ATTACHMENTS_CLEAN_BUCKET")
CHAT_ATTACHMENTS_QUARANTINE_BUCKET = os.environ.get(
    "CHAT_ATTACHMENTS_QUARANTINE_BUCKET"
)
CHAT_ATTACHMENTS_SCANNER_BACKEND = os.environ.get(
    "CHAT_ATTACHMENTS_SCANNER_BACKEND", ""
).strip()
CHAT_ATTACHMENTS_SCANNER_URL = os.environ.get(
    "CHAT_ATTACHMENTS_SCANNER_URL", ""
).strip()
CHAT_ATTACHMENTS_SCANNER_AUDIENCE = os.environ.get(
    "CHAT_ATTACHMENTS_SCANNER_AUDIENCE", CHAT_ATTACHMENTS_SCANNER_URL
).strip()
CHAT_ATTACHMENTS_SCANNER_TIMEOUT_SECONDS = float(
    os.environ.get("CHAT_ATTACHMENTS_SCANNER_TIMEOUT_SECONDS", "120")
)
CHAT_ATTACHMENTS_SERVICE_ACCOUNT_INFO = os.environ.get(
    "CHAT_ATTACHMENTS_SERVICE_ACCOUNT_JSON"
)
CHAT_ATTACHMENTS_SIGNING_SERVICE_ACCOUNT = os.environ.get(
    "CHAT_ATTACHMENTS_SIGNING_SERVICE_ACCOUNT", ""
)
